...
const TableList: React.FC = () => {
  ...
  const columns: ProColumns<API.RuleListItem>[] = [
    ...
    },
    {
      ...
      sorter: true,
      hideInForm: true,
      renderText: (val: string) => `${val}${intl.formatMessage({id: 'pages.searchTable.tenThousand', defaultMessage: ' 万 '})}`,
    },
    {
  ...
  return (
    <PageContainer>
      ...
      >
        <ProFormText
          rules={[{required: true, message: (<FormattedMessage id="pages.searchTable.ruleName" defaultMessage="Rule name is required"/>)}]}
          width="md"
          name="name"
        />
